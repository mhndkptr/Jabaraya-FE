                ...
                <div className="flex flex-col justify-between flex-grow">
                  <div>
                    ...
                    <div className="flex gap-2 mb-4 justify-end">
                      ...
                      <span className="text-xs border font-semibold border-jabarayaColors-700 p-1 rounded-md text-jabarayaColors-700">
                        Umum
                      </span>
                      <span className="text-xs border font-semibold border-jabarayaColors-700 p-1 rounded-md text-jabarayaColors-700">
          ...
          <div className="relative w-full max-w-2xl p-4 max-h-full">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button
                  type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" onClick={closeModal}>
              ...
              <div className="p-4 md:p-5 space-y-4">
                <img
                  src={`http://127.0.0.1:8000/storage/${selectedEvent.thumbnail}`}
                  alt={selectedEvent.name}
                  className="object-cover rounded-md w-full h-auto mb-2 lg:mb-4"/>
                  <p className="text-black font-bold dark:text-white text-sm">{selectedEvent.name
                  }</p>
              ...
              <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600 gap-2">
                <a href={`/eventLengkap/${selectedEvent.id}`} className="w-full hidden rounded-md shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] px-2 py-3 md:flex justify-center items-center mt-4">
                  <p className="font-medium">Baca Selengkapnya</p>
                </a>
              </div>
            </div>
