    ...
    <section className="border-black w-full min-h-screen   px-5 md:px-28 mt-10 -z-10">
      ...
      <aside className="bg-jabarayaColors-200  flex flex-col w-full h-auto mt-5 rounded-xl lg:grid lg:grid-cols-[1fr,1fr] md:p-10 p-4 ">
        ...
        <div className="flex justify-center items-center order-1 lg:order-2 mb-2">
          <img src={`http://127.0.0.1:8000/storage/${culture.thumbnail}`} alt={culture.title} className=" border border-black rounded-lg lg:w-[350px] lg:h-[300px]"/>
        </div>
      </aside>
      <main className="flex flex-col justify-center items-center mt-10">
        ...
        <p className="mb-5 text-justify text-[12px] md:text-[1rem]" dangerouslySetInnerHTML={{ __html: culture.content }}>
        </p>
          <div className="mt-10">
            <p>
                  ...
                  {[...Array(10)].map((_, index) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between mt-2">
                        ...
                        <button
                          className="shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] text-black py-1 px-3 rounded">
                          Lihat di google
                        </button>
                      </div>
                    </div>
