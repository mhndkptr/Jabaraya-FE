...
export default function SortCulture() {
  ...
  return (
    <section className="border-black w-full min-h-screen px-5 md:px-28 mt-10 -z-10">
      <h2 className="text-4xl text-center mt-16 font-semibold">Budaya Asli Bandung</h2>
      ...
      <button className="flex items-center rounded-md p-2 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] justify-start" onClick={() => navigate(-1)}>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {cultures.map((culture) => (
          <div key={culture.id} className="bg-white shadow-md rounded-lg p-4">
            <img src={`${culture.thumbnail}`} alt={culture.title} className="object-cover rounded-md w-full h-48 mb-2 lg:mb-4" />
