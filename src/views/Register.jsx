      ...
      <div className="grid md:grid-cols-2 w-full">
        <div className="flex flex-col items-center justify-center bg-loginRegister-gradient py-10 px-5 md:py-24">
          <div className="max-w-lg w-full bg-white border rounded-xl p-5 md:p-10">
            ...
            <form className="mb-4" name="wf-form-password" method="post" onSubmit={handleRegister}>
              <div className="relative mb-4">
                <label className="block text-left">Nama</label>
                <input ref={nameRef} type="text" className="block w-full border rounded-xl bg-white px-3 py-2 text-sm text-black" name="name" placeholder="Masukan Nama" required />
              </div>
              <div className="relative mb-4">
              ...
              <div className="relative mb-4">
                ...
                <input ref={phoneRef} type="number" className="block w-full border rounded-xl bg-white px-3 py-2 text-sm text-black" name="phone" placeholder="Masukan Nomor Telepon" required />
              </div>
              <div className="relative mb-4">
              ...
              <div className="relative mb-4">
                ...
                <input ref={passwordConfirmationRef} type="password" className="block w-full border rounded-xl bg-white px-3 py-2 text-sm text-black" placeholder="Konfirmasi Password" required />
              </div>
