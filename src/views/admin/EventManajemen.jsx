...
export default function EventManajemen() {
  ...
  const handleEditSubmit = (e) => {
    ...
    axiosClient
      .post(`/events/${EditEvent.id}`, formData, {
        headers: {
                  ...
                  <div className="grid gap-4 mb-4 grid-cols-2">
                    <div className="col-span-2">
                      ...
                      <input
                        ...
                        className="block w-full p-2.5 text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Enter name"
                      />
                    </div>
                    <div className="col-span-2">
                      <label htmlFor="thumbnail" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Thumbnails
                      </label>
                      <input
                        type="file"
                        ...
                        className="block w-full p-2.5 text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 shadow-md hover:shadow-lg focus:outline-none focus:bg-white dark:focus:bg-gray-600 transition duration-200 ease-in-out"
                      />
                    </div>
                    <div className="col-span-2">
                      <label htmlFor="start_date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Start Date
                      </label>
                      <input
                        type="datetime-local"
                    ...
                    <div className="col-span-2">
                      <label htmlFor="end_date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        End Date
                      </label>
                      <input
                        type="datetime-local"
                    ...
                    <div className="col-span-2">
                      <label htmlFor="content" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Content
                      </label>
                      <CKEditor
                        ...
                        config={{
                          ckfinder: {
                            uploadUrl: `${import.meta.env.VITE_API_BASE_URL}/api/events/upload-image`,
                          },
                    ...
                    <div className="col-span-2">
                      <label htmlFor="link" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Link
                      </label>
                      <input
                        type="url"
                    ...
                    <div className="col-span-2">
                      <label htmlFor="category_id" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Category
                      </label>
                      <select
                        id="category_id"
      ...
      {modalVisible && selectedEvent && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-11/12 md:w-1/3">
            ...
            {/* thumbnail */}
            <img src={`${selectedEvent.thumbnail}`} alt={selectedEvent.name} className="w-full h-64 object-cover mb-4 rounded-lg" />
            <p className="dark:text-white">
              <strong className="text-gray-900 dark:text-gray-100">Location:</strong>{" "}
              <a href={selectedEvent.location} target="_blank" rel="noopener noreferrer" className="text-blue-500 dark:text-blue-400">
                {selectedEvent.location}
              </a>
            </p>
            <p className="dark:text-white">
              <strong className="text-gray-900 dark:text-gray-100">Start Date:</strong> {selectedEvent.start_date}
            </p>
            <p className="dark:text-white">
              <strong className="text-gray-900 dark:text-gray-100">End Date:</strong> {selectedEvent.end_date}
            </p>
            {/* <p className="dark:text-white"><strong className="text-gray-900 dark:text-gray-100">Content:</strong> {selectedEvent.content}</p> */}
            <p>
              <strong className="text-gray-900 dark:text-gray-100">Link:</strong>{" "}
              <a href={selectedEvent.link} target="_blank" rel="noopener noreferrer" className="text-blue-500 dark:text-blue-400">
                {selectedEvent.link}
              </a>
            </p>
            <button
              onClick={closeModal}
              className="mt-4 inline-flex items-center text-black bg-transparent border border-black hover:bg-jabarayaColors-700 hover:text-white hover:border-none focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-gray-600 dark:hover:text-white dark:text-white dark:border-none dark:bg-gray-700"
            >
              Close
            </button>
            <button
              onClick={() => handleDelete(selectedEvent.id)}
              className="mx-2 mt-4 inline-flex items-center text-red-700 bg-transparent border border-black hover:bg-red-700 hover:text-white hover:border-none focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:hover:bg-gray-600 dark:hover:text-white dark:text-white dark:border-none dark:bg-gray-700"
            >
              Delete
            </button>
            <button
