...
export default function Beranda() {
  return (
    ...
    <section>
      ...
      <section
        id="BuatRencana"
        className="w-full md:h-screen  h-auto  bg-white md:bg-jabarayaColors-50 flex justify-center items-center px-4"
      >
        <div className="flex flex-col justify-center items-center p-3 ">
          ...
          <div className="md:w-[700px] md:h-[310px]  w-[328px] sm:w-[600px]   h-[253px] bg-jabarayaColors-700  shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-xl p-4">
