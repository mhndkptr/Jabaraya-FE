    ...
    <section>
      ...
      <section className="w-full pt-10 md:mt-0 h-auto md:h-screen px-4 flex-col md:flex-row bg-white md:bg-jabarayaColors-100 flex lg:justify-center items-center md:px-4">
        <div className="flex flex-col  w-full  md:items-center py-2 ">
          ...
          {/* CONTAINER BERITA */}
          <div className="mt-6 w-[350px]  sm:w-[520px] h-[420px] md:min-w-[750px] lg:w-auto md:h-auto md:flex md:px-4 grid grid-flow-col gap-4 lg:justify-center items-center overflow-x-auto md:overflow-hidden    ">
        ...
        <div className="flex flex-col justify-center items-center mt-10">
          ...
          <div className="h-auto mt-5 flex justify-center items-center flex-wrap gap-4 md:gap-6 lg:gap-8">
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Tari di Bandung</h1>

              <div className="flex flex-col justify-center items-center p-2 w-full">
                <img src={berita1} alt="" className="object-cover rounded-md md:w-[317px] md:h-[230px]" />
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Wayang di Bandung</h1>
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Kuliner di Bandung</h1>
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Musik di Bandung</h1>
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Alat Musik di Bandung</h1>
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Senjata di Bandung</h1>
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Rumah Adat di Bandung</h1>
            ...
            <div className="bg-slate-50 shadow-md rounded-lg  flex flex-col justify-start items-start gap-0 w-[152px] h-[171px] p-2  md:w-[300px] md:h-[370px] lg:w-[362px] lg:h-[390px]">
              <h1 className="font-bold text-[11px]  md:text-[20px] lg:text-[26px] p-1 ">Museum di Bandung</h1>
