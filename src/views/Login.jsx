        ...
        <div className="flex flex-col items-center justify-center bg-loginRegister-gradient py-10 px-5 md:py-24">
          <div className="max-w-lg w-full bg-white border rounded-xl p-5 md:p-10">
            ...
            <div className="mt-7 flex flex-col gap-2">
              <button className="mb-5 inline-flex h-10 w-full items-center justify-center gap-2 rounded border border-slate-300 bg-white p-2 text-sm font-medium text-black outline-none focus:ring-2 focus:ring-[#333] focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60">
            ...
            <p className="text-sm text-slate-500 mt-4">
              Tidak Punya Akun? <a href="Register" className="text-sm font-bold text-black">Daftar disini</a>
            </p>
          </div>
        </div>
      </div>
